...
/**
  ...
  @param[in]      OverrideWithWriteCombine  Boolean for overriding the default attributes with Write Combine
...
RegisterNonDiscoverableMmioDevice (
  ...
  IN      BOOLEAN                           OverrideWithWriteCombine,
  ...
  )
{
  ...
  Device->OverrideWithWriteCombine = OverrideWithWriteCombine;
